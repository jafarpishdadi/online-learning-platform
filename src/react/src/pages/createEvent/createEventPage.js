...
let headerItems = {link: '/profile', title: 'Create a New Event', profileImg: profile }
...
class CreateEventPage extends Component {
	render() {
		...
		return(
            ...
            <div class= "box-2">
                <div class="picture-book"><img src={calendar} alt="Map"></img>
                <h1 class="header-create-class">Create the Event</h1></div>
                <div>
                <p>Use the form below to create an event that members of UImpactify can join</p>
