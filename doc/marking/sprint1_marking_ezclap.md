...
## User Stories (Tracked in Jira) (7.75/10) 
...
## Notes
- RPM: Missing ticket reference to user story
- User Stories: Missing low priorities, an indicator for things you want to tackle at the end even if you think all of them are important
- User Stories: Missing acceptance criteria
- Tracking on Jira: 
  - There shouldn't be consecutive pull requests like #8-#16
  - In github->insights->networks, I see some branch off of user story branch. I would like to see more branch off of user story branch as it is a good indicator of task breakdown.
- Branch Naming: naming convention: "EZ-#", should be followed more strictly.
- CRC Cards: Would be easier to read if collaborators were indexed by another tab. 
